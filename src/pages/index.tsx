      ...
      <section className="flex flex-col h-full items-center justify-center relative px-4">
        ...
        <div className="inline-block text-center justify-center max-w-4xl relative z-10">
            ...
            <h1 className="leading-tight tracking-tight">
              ...
              <span
                className={title({
                  color: "blue",
                  className:
                    "text-4xl sm:text-5xl lg:text-6xl font-medium bg-gradient-to-r from-blue-600 via-violet-600 to-pink-600 dark:from-blue-400 dark:via-violet-400 dark:to-pink-400 bg-clip-text text-transparent",
                })}
              >
                professionals&nbsp;
              </span>
          ...
          >
            <Dropdown>
              <DropdownTrigger>
                <Button className="group relative py-5 sm:px-14 sm:py-6 bg-white dark:bg-gray-900 rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-300 hover:scale-[1.02] border border-gray-200/50 dark:border-gray-700/50 backdrop-blur-sm w-full sm:w-auto">
              ...
              <DropdownMenu
                aria-label="Portfolio Accelerator Options"
                onAction={(key) => navigate(key.toString())}
              >
                <DropdownItem key="/consultation">
                  Individual consultation
                </DropdownItem>
                <DropdownItem key="/program">
                  Full individual program
                </DropdownItem>
              </DropdownMenu>
            </Dropdown>
