  ...
  return (
    <DefaultLayout>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <section className="flex flex-col items-center justify-center gap-16 sm:gap-24 lg:gap-32 py-8 sm:py-12 relative">
          {/* Logos */}
          <div className="flex flex-col items-center justify-center gap-16 w-full">
            <div className="flex items-center justify-center gap-4 sm:gap-8 sm:gap-12">
              {[
                { src: "/logo.png", className: "dark:hidden w-48 lg:w-64" },
                {
                  src: "/logo-dark.png",
                  className: "hidden dark:block w-48 lg:w-64",
                },
              ].map((logo, index) => (
                <motion.img
                  key={index}
            ...
            <div className="text-center space-y-8">
              ...
              >
                ...
                >
                  3-Month SAT Accelerator by Parvoz
                </h1>
              </motion.div>
              <motion.p
                animate={{ opacity: 1 }}
          ...
          <FadeInWhenVisible variant="slideUp">
            <div className="flex flex-col sm:flex-row w-full items-center justify-between gap-8 sm:gap-16 bg-gray-50 dark:bg-gray-800/50 rounded-3xl p-6 sm:p-8 lg:p-16 mt-12 sm:mt-16 lg:mt-24">
              ...
              <div className="flex flex-col gap-8 items-center text-center sm:text-left max-w-2xl">
                ...
                >
                  This 3-month program helps high school andgap year students excel in their 
                  SATpreparation with a personalized approach <br/>📅 Months 1 & 2: Master core SAT 
                  topics andbuild essential skills. <br/>📅 Month 3: Full-length practice tests 
                  andfocused review to ensure top SAT scores. <br/>🎯 Target Exam Date: May 3rd, 
                  June 7th 2025.
                </p>
              </div>
            </div>
